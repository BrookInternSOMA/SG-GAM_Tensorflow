...
parser.add_argument('--img_height', dest='img_height', type=int, default=480, help='image height')
parser.add_argument('--img_width', dest='img_width', type=int, default=640, help='image width')
...
parser.add_argument('--segment_class', dest='segment_class', type=int, default=3, help='number of segmentation classes')
